        ...
        <div className="bg-zinc-50">
            <div className="container py-8 text-center lg:py-0 lg:text-left lg:flex lg:justify-between ">
                <div className="lg:w-1/2 xl:py-14 lg:py-8">
                    ...
                    <h1 className="py-4 text-3xl font-extrabold leading-tight text-gray-800 xl:text-6xl lg:text-4xl">Transform Your Space <br />with Expert Design!</h1>
                    <p className="pb-6 text-gray-500 xl:pb-10">
                    we bring creativity and functionality together to craft  <br /> personalized spaces that reflect your style and vision. <br />From concept to completion, our expert team is dedicated to transforming your dream interiors into reality.
                    </p>
