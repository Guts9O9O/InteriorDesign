    ...
    return (
        <div className="container py-16">
            <div className="flex items-center justify-between pb-4">
                <a className="py-4 text-3xl font-extrabold leading-tight text-gray-800 lg:text-5xl" href="">Designing Spaces,  <br />Inspiring Lives</a>
            ...
            <div className="grid lg:grid-cols-2 place-items-center ">
                ...
                <div className="items-center">
                    ...
                    We specialize in creating stunning interiors that reflect your personality and lifestyle. With a focus on elegance and functionality, our designs turn your vision into a reality youll love.
                    </p>
